...
import com.criss.demo.domain.model.YogurtBatch;
import com.criss.demo.domain.repository.TemperatureLogRepository;
import com.criss.demo.domain.repository.YogurtBatchRepository;
import com.criss.demo.domain.service.TemperatureControlService;
import com.criss.demo.dto.MonitoringDTO;
...
public class MonitoringController {
    ...
    public ResponseEntity<List<TemperatureLog>> getTemperatureLogs(
        ...
        YogurtBatch batch = batchRepository.findById(batchId)
            .orElseThrow(() -> new RuntimeException("Batch no encontrado con id: " + batchId));
